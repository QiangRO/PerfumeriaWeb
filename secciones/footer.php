            ...
            <div class="row">
                <div class="col-lg-6 pr-lg-5 mb-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="mb-3 text-white"><span class="text-primary">Beauty </span>Station</h1>
                    </a>
                    <p>El Salón de belleza Beauty Station, se encarga del arreglo personal en mujeres, varones donde se realizan cortes, tintes, peinados, maquillado, uñas, cejas y pestañas y otros.</p>
                    <p><i class="fa fa-map-marker-alt mr-2"></i>Calle 27 B. Beauty Station está situada circa de la comisaría Distrito Policial No 3 y del hospital Caja Nacional de Salud CNS.</p>
                    <p><i class="fa fa-phone-alt mr-2"></i>+59112345678</p>
                    <p><i class="fa fa-envelope mr-2"></i>beautystation@gmail.com</p>
                    <div class="d-flex justify-content-start mt-4">
                        <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="https://twitter.com" target="_blank"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="https://www.facebook.com" target="_blank"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-lg btn-primary btn-lg-square mr-2" href="#" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                        <a class="btn btn-lg btn-primary btn-lg-square" href="https://www.instagram.com/" target="_blank"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
                <!-- <div class="col-lg-6 pl-lg-5">
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-5">
                            <h5 class="text-white text-uppercase mb-4">Escribenos</h5>
                            <div class="w-100">
    ...
    <!-- Botón de enlace para abrir el modal -->
<a href="#" class="btn btn-sm btn-primary d-flex flex-column align-items-center justify-content-center" data-toggle="modal" data-target="#chatModal" id="openChatButton" style="position: fixed; right: 30px; bottom: 100px; width: 150px; height: 150px; border-radius: 5px; z-index: 1000;">
  <i class="fa fa-comment" style="font-size: 120px; margin-bottom: 10px;"></i>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="chatModalLabel">Chat de Beauty Station</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <!-- Contenido del chat, formulario de chat y área de visualización -->
...
input {
    ...
    border-radius: 5px; /* Ajuste según tus necesidades */
}
...
.me {
    ...
    padding: 10px;
    margin: 5px;
    background-color: pink; /* Cambia a tu tono de rosa oscuro deseado */
    border-radius: 10px;
    float: right;
    text-align: right;
    display: block;
...
.alicia {
    ...
    padding: 10px;
    margin: 5px;
    background-color: pink; /* Cambia a tu tono de rosa deseado */
    border-radius: 10px;
    float: left;
    text-align: left;
    display: block;
    ...
    border-radius: 150px;
        ...
        <div class="chatbox">
          ...
          <form class="chat" id="chatForm">
            <div>
              <input type="text" name="chat" id="chatMessage" placeholder="Pregúntame algo" style="font-family: cursive; font-size: 20px;">
            </div>
            <div>
...
const kekoJonesBtn = document.getElementById("kekoJonesBtn");
  ...
  const productos = {
    "polo blue": { nombre: "Polo Blue", stock: 25, descripcion: "Exótica fragancia floral con toques cítricos, te lleva a un jardín primaveral vibrante y encantador.", precio: 70 },
    "wour poure homme": { nombre: "Wour Poure Homme", stock: 107, descripcion: "Descripción de Wour Poure Homme.", precio: 85 },
    "uomo": { nombre: "Uomo", stock: 58, descripcion: "Descripción de Uomo.", precio: 60 },
    "polo black": { nombre: "Polo Black", stock: 24, descripcion: "Descripción de Polo Black.", precio: 75 },
    "a* men recarga": { nombre: "A* Men Recarga", stock: 58, descripcion: "Descripción de A* Men Recarga.", precio: 90 },
  };
...
"compra": "¡Genial que estés interesado en comprar! Puedes optar por utilizar nuestro carrito de compras con opción de pago por PayPal. Si prefieres asistencia personalizada, también puedes comunicarte directamente con nuestro equipo de ATENCIÓN AL CLIENTE. Ellos estarán encantados de ayudarte en el proceso de compra y, si lo deseas, te enviarán el QR directamente. Nuestro EXPERTO EN FRAGANCIAS también está disponible para asesorarte y garantizar que elijas la fragancia perfecta. ¡Esperamos que encuentres la experiencia de compra y la fragancia ideales!",
  ...
  "gracias": "¡De nada! Estoy aquí para ayudarte. Si tienes más preguntas o necesitas asistencia en el futuro, no dudes en preguntar. ¡Que tengas un excelente día!",
    ...
    // Respuestas para listar los productos disponibles (más posibilidades)
  "mostrame tus perfumes": `Aquí están nuestros perfumes: Polo Blue, Wour Poure Homme, Uomo, Polo Black, A* Men Recarga.`,
  "dime tus fragancias": `Tenemos fragancias como Polo Blue, Wour Poure Homme, Uomo, Polo Black y A* Men Recarga.`,
 ...
 "fragancias": "Actualmente, contamos con los siguientes productos: Polo Blue, Wour Poure Homme, Uomo, Polo Black, A* Men Recarga.",
  ...
  const matchedResponses = Object.entries(botResponses).find(([keyword, response]) => {
...
;
  ...
  chatModal._element.addEventListener("hidden.bs.modal", closeChatModal);
});
...
<!-- Agregar las bibliotecas de animate.css (si aún no están incluidas) -->
