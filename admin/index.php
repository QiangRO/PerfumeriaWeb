...
$totales = [
	["nombre" => "Total productos", "total" => obtenerNumeroProductos(), "imagen" => "../public/images/admin/productos.png"],
	["nombre" => "Ventas registradas", "total" => obtenerNumeroVentas(), "imagen" => "../public/images/admin/ventas.png"],
	["nombre" => "Usuarios registrados", "total" => obtenerNumeroUsuarios(), "imagen" => "../public/images/admin/usuarios.png"],
	["nombre" => "Clientes registrados", "total" => obtenerNumeroClientes(), "imagen" => "../public/images/admin/clientes.png"],
];
